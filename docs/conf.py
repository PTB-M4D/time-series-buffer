...
# -*- coding: utf-8 -*-
#
# time-series-metadata documentation is based on PyDynamics conf.py.
#
...
project = "time-series-metadata"
copyright = (
    "2020, Maximilian Gruber (PTB), Björn Ludwig (PTB), Bang Xiang Yong (UCAM), "
    "Benedikt Seeger (PTB)"
)
...
htmlhelp_basename = "time-series-metadatadoc"
...
latex_documents = [
    (
        master_doc,
        "time-series-metadata.tex",
        "time-series-metadata Documentation",
        "Maximilian Gruber, Björn Ludwig, Bang Xiang Yong, Benedikt Seeger",
        "manual",
    ),
]
